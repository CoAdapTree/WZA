...
setwd("~/UBC/GEA/WZA/SimulationStudy/directionalSelection/G.2.3/isolation_by_distance/")
...
setwd("~/UBC/GEA/WZA/SimulationStudy/directionalSelection/G.2.3/LD_decay/")
